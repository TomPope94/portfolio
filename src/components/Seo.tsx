...
const defaultMeta = {
  title: "Tom Pope",
  siteName: "Portfolio for Tom Pope",
  description:
    "A portfolio website for showing the work of Tom Pope. Full stack development, entrepreneurship and data engineering.",
  url: "https://popeportfolio.co.uk",
  type: "website",
  robots: "follow, index",
  /**
